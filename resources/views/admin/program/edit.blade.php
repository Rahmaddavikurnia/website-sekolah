          ...
          <div class="page-inner">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="{{route('kabar-update',$kabars)}}" method="POST" enctype="multipart/form-data">
                  @method('patch')
                    @csrf
                  <div class="card-body"> 
                    <div class="row">
                      <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="judul_kabar" value="{{$kabars->judul_kabar}}"/>
                        </div>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="tanggal_terbit" value="{{$kabars->tanggal_terbit}}"/>
                        </div>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            class="form-control form-control"
                            id="berlaku"
                            placeholder="Masukkan Tanggal Berlaku"x`
                            name="tanggal_berlaku" value="{{$kabars->tanggal_berlaku}}"/>
                        </div>
                      ...
                      <div class="col-md-6 col-lg-6">
                        ...
                        <select name="related_type" id="related_type" class="form-select form-control" required">
                          <option value="sarana" {{ $kabars->related_type == 'sarana' ? 'selected' : '' }}>Sarana</option>
                          <option value="humas" {{ $kabars->related_type == 'humas' ? 'selected' : '' }}>Humas</option>
                          <option value="kesiswaan" {{ $kabars->related_type == 'kesiswaan' ? 'selected' : '' }}>Kesiswaan</option>
                          <option value="kurikulum" {{ $kabars->related_type == 'kurikulum' ? 'selected' : '' }}>Kurikulum</option>
                        </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="isi" rows="5" name="isi_kabar">{{$kabars->isi_kabar}}
                            </textarea>
                          </div>
                      </div>
                    </div>
