                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending" style="width: 250.125px;">Nama Jurusan</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Deskripsi: active to sort column ascending" style="width: 300.375px;">Deskripsi</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending" style="width: 200.375px;">Foto jurusan</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td><img src="{{asset ('storage/jurusan/' .$item->foto)}}" alt="img" height="50px"></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('j.update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
                                                        ...
                                                        <form action="{{route('j.destroy',$item->id)}}" method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <button
                                                            type="submit"
