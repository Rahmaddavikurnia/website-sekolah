                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending" style="width: 250.125px;">Nama Kelas</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Deskripsi: active to sort column ascending" style="width: 300.375px;">Jurusan</th>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('kelas-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
                                                        ...
                                                        <form action="{{route('kelas-delete',$item)}}" method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <button
                                                            type="submit"
