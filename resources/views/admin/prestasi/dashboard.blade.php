                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending">Nama Prestasi</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jurusan: active to sort column">Nama Siswa</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jabatan: active to sort column">Kategori</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending" style="width: 200.375px;">Foto Prestasi</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row">
                                                <td>{{$item->id}}</td>
                                                <td>{{$item->title}}</td>
                                                <td>{{ implode(', ', $item->siswa->pluck('nama')->toArray()) }}</td>
                                                <td>{{$item->kategori}}</td>
                                                <td><img src="{{asset ('storage/images/prestasi/' .$item->gambar)}}" alt="img" height="50px"></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('prestasi-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
