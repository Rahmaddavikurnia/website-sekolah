                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending";">Nama Siswa</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Deskripsi: active to sort column ascending">NISN</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending">jurusan</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending">Kelas</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('siswa-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
