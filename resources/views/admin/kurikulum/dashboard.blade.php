                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama kurikulum: active to sort column descending" style="width: 250.125px;">Nama Kurikulum</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column" style="width: 250.125px;">Jurusan</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('kurikulum-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
