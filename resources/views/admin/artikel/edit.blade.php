          ...
          <div class="page-inner">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="{{route('artikel-update',$artikels)}}" method="POST" enctype="multipart/form-data">
                  @method('patch')
                    @csrf
                  <div class="card-body"> 
                    <div class="row">
                      <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="judul_artikel" value="{{$artikels->judul_artikel}}"/>
                        </div>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="tanggal_terbit" value="{{$artikels->tanggal_terbit}}"/>
                        </div>
                      ...
                      <div class="col-md-6 col-lg-6">
                        ...
                        <select name="kategori_type" id="kategori_type" class="form-select form-control" required">
                          <option value="sarana" {{ $artikels->related_type == 'sarana' ? 'selected' : '' }}>Sarana</option>
                          <option value="humas" {{ $artikels->related_type == 'humas' ? 'selected' : '' }}>Humas</option>
                          <option value="kesiswaan" {{ $artikels->related_type == 'kesiswaan' ? 'selected' : '' }}>Kesiswaan</option>
                          <option value="kurikulum" {{ $artikels->related_type == 'kurikulum' ? 'selected' : '' }}>Kurikulum</option>
                        </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="isi" rows="5" name="isi_artikel">{{$artikels->isi_artikel}}
                            </textarea>
                          </div>
                      </div>
                    </div>
