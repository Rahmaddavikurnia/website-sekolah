              ...
              <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Peluang Karir</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama kurikulum: active to sort column descending">Nama Karir</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column">Jurusan</th>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('peluangkarir-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
                                                        ...
                                                        <form action="{{route('peluangkarir-delete',$item)}}" method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <button
                                                            type="submit"
