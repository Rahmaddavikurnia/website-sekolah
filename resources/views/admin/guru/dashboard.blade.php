                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending">Nama Jurusan</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jurusan: active to sort column">Jurusan Mengajar</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jabatan: active to sort column">Jabatan</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending" style="width: 200.375px;">Foto Guru</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>{{$item->jabatan}}</td>
                                                <td><img src="{{asset ('storage/images/guru/' .$item->gambar)}}" alt="img" height="50px"></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('guru-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
