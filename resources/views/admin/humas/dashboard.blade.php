              ...
              <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Program Humas</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama kegiatan: active to sort column descending">Judul Kegiatan</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="tanggal: active to sort column">Tanggal Kegiatan</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="tempat: active to sort column">Tempat</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column">Foto Kegiatan</th>
                                        ...
                                        <tbody>
                                            @foreach ($humass as $item)
                                            <tr role="row">
                                                <td>{{$item->id}}</td>
                                                <td>{{$item->judul_kegiatan}}</td>
                                                <td>{{$item->tanggal_kegiatan}}</td>
                                                <td>{{$item->tempat}}</td>
                                                <td><img src="{{asset ('storage/images/humas/' .$item->gambar)}}" alt="img" height="50px"></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('humas-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
                                                        ...
                                                        <form action="{{route('humas-delete',$item)}}" method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <button
                                                            type="submit"
