          ...
          <div class="page-inner">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <form action="{{route('sarana-update',$saranas)}}" method="POST" enctype="multipart/form-data">
                  @method('patch')
                    @csrf
                  <div class="card-body"> 
                    <div class="row">
                      <div class="col-md-12 col-lg-12">
                        ...
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="lokasi" value="{{$saranas->lokasi}}"/>
                        </div>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="kapasitas" value="{{$saranas->kapasitas}}"/>
                        </div>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="gambar" value="{{$saranas->gambar}}"/>
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi Sarana</label>
                            <textarea class="form-control" id="deskripsi" rows="5" name="deskripsi">{{$saranas->deskripsi}}
                            </textarea>
                          </div>
                        </div>
                    </div>
