                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama sarana: active to sort column descending">Nama Sarana</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="lokasi: active to sort column">Lokasi Sarana</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="kapasitas: active to sort column">Kapasitas sarana</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column">Foto Sarana</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td><img src="{{asset ('storage/images/sarana/' .$item->gambar)}}" alt="img" height="50px"></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('sarana-update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
                                                        ...
                                                        <form action="{{route('sarana-delete',$item)}}" method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <button
                                                            type="submit"
